package com.spachecor.ejerciciofinalsgb.model.mapper;
...
public class PrestamoMapper implements Mapper<Prestamo> {
    ...
    public Prestamo deXML(String xml) {
        ...
        try{
            ...
            prestamo.setDevuelto(Boolean.parseBoolean(root.getElementsByTagName("returned").item(0).getTextContent()));
        }catch (Exception e){
            e.printStackTrace();
        }
        return prestamo;
